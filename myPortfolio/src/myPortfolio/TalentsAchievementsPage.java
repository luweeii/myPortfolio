...
public class TalentsAchievementsPage {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TalentsAchievementsPage window = new TalentsAchievementsPage();
	 ...
	 */
	public TalentsAchievementsPage() {
		initialize();
	}
	...
	private void initialize() {
		...
		frame.setTitle("Talents & Achievements");
